"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.codeSorryTemplate=void 0;const codeSorryTemplate=(code,ip,device)=>{return`
 <!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body class="body-content" style="max-width: 450px !important; margin: 0 auto !important;" data-ogsc="light-mode">
    ...
    <p style="font-weight: 400; font-size: 16px; line-height: 22px">
      <span style="font-weight: 700; font-size: 16px; line-height: 22px">Country:</span> ${ip?ip:"-"}
    </p>

    <p style="font-weight: 400; font-size: 16px; line-height: 22px">
      <span style="font-weight: 700; font-size: 16px; line-height: 22px">Device:</span> ${device?device:"-"}
    </p>
    ...
    `};exports.codeSorryTemplate=codeSorryTemplate;