...
<body style="margin: 0; display: flex; justify-content: center; align-items: center; flex-direction: column; width: 100%; height: 100%; padding: 0;">
  <div style="background-image: url('https://mltr.ibotchori.space/images/tile.png');  font-weight: 400; text-align: center; height: 100%; display: flex; align-items: center; justify-content: center;">
