      ...
      >
        <div style="padding: 10px 20px">
          <img
            ...
            alt="MLTR Logo"
            style="max-width: 100%; width: 85px; height: 85px"
          />
  
          <p>Hello there, Thank you for registering with MLTR!</p>
          <p>
            We're so happy you're here and can't wait for you to start using our
            app to track your nutrition. To complete the registration process,
          ...
          <p>
            ...
            <a
              ...
              style="color: #c4ff46; text-decoration: none"
          ...
          <p>
            ...
            please don't hesitate to contact our support team. We're always here
            to help. Thanks for choosing our app to help you reach your nutrition
            goals!
            <br /><br />
            Warm regards,<br />
            The MLTR Team
