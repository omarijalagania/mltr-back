...
<body style="margin: 0; display: flex; justify-content: center; align-items: center; flex-direction: column; width: 100%; height: 100%; padding: 0;">
  <div style="background-image: url('https://mltr.ibotchori.space/images/outline-black.gif'); color: #FFFFFF; font-size: 16px; font-weight: 400; text-align: center; height: 100%; display: flex; align-items: center; justify-content: center;">
    <div style="padding: 10px 20px;">
      ...
      <p style="color: #FFFFFF !important;">We're so happy you're here and can't wait for you to start using our app to track your nutrition. To complete the registration process, please enter the following verification code in the app:</p>
      ...
      <div style="display: flex; align-items: center; justify-content: center;">
        ...
        <div style="font-size: 14px; text-align: center; margin-left: 5px; color: #FFFFFF !important;">ONYX Labs</div>
        <a href="https://onyxlabs.tech/terms.html" style="font-size: 14px;  color: #C4FF46 !important; margin-left: 5px; text-decoration: none;">Terms and Conditions</a>
        <a href="https://onyxlabs.tech/privacy.html" style="font-size: 14px; color: #C4FF46 !important; margin-left: 5px; text-decoration: none; margin-left: 10px;">Privacy Policy</a>
      </div>
    </div>
